...
if [ $stage -le 12 ] && [ $stop_stage -gt 12 ] ; then
  ...
  relu-batchnorm-layer name=tdnn1 dim=$layer_dim
  relu-batchnorm-layer name=tdnn2 input=Append(-1,0,1) dim=$layer_dim
  relu-batchnorm-layer name=tdnn3 input=Append(-1,0,1) dim=$layer_dim

  # check steps/libs/nnet3/xconfig/lstm.py for the other options and defaults
  norm-opgru-layer name=opgru1 cell-dim=$layer_dim recurrent-projection-dim=$linear_layer_dim non-recurrent-projection-dim=$linear_layer_dim delay=-3 dropout-per-frame=true dropout-proportion=0.0
  relu-batchnorm-layer name=tdnn4 input=Append(-3,0,3) dim=$layer_dim
  relu-batchnorm-layer name=tdnn5 input=Append(-3,0,3) dim=$layer_dim
  norm-opgru-layer name=opgru2 cell-dim=$layer_dim recurrent-projection-dim=$linear_layer_dim non-recurrent-projection-dim=$linear_layer_dim delay=-3 dropout-per-frame=true dropout-proportion=0.0
  relu-batchnorm-layer name=tdnn6 input=Append(-3,0,3) dim=$layer_dim
  relu-batchnorm-layer name=tdnn7 input=Append(-3,0,3) dim=$layer_dim
  norm-opgru-layer name=opgru3 cell-dim=$layer_dim recurrent-projection-dim=$linear_layer_dim non-recurrent-projection-dim=$linear_layer_dim delay=-3 dropout-per-frame=true dropout-proportion=0.0
