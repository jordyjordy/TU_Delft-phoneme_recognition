...
remove_egs=false
common_egs_dir=exp/chain/tdnn_opgru1a2_sp/egs/
...
#   lstm_opts="l2-regularize=0.0005 decay-time=40"
  ...
  relu-batchnorm-layer $opts name=tdnn1 dim=$layer_dim
  relu-batchnorm-layer  $opts name=tdnn2 input=Append(-1,0,1) dim=$layer_dim
  relu-batchnorm-layer $opts name=tdnn3 input=Append(-1,0,1) dim=$layer_dim
