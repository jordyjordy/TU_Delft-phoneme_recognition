...
from reverberate_data_dir_latin_1_enc import parse_file_to_dict
from reverberate_data_dir_latin_1_enc import write_dict_to_file
...
def get_noise_list(noise_wav_scp_filename):
    noise_wav_scp_file = open(noise_wav_scp_filename, 'r', encoding='latin-1').readlines()
    noise_wavs = {}
    noise_utts = []
...
def main():
    ...
    wav_scp_file = open(input_dir + "/wav.scp", 'r', encoding='latin-1').readlines()
